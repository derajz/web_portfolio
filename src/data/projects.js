...
export const projects = [
  {
    ...
    summary:
      'Real-world business system developed during my System Developer internship. A booking platform for air conditioning services with customer-facing interface and administrative management.',
    problem:
      'Bookings were tracked on paper and spreadsheets. The business needed a centralized system to manage reservations, track service history, maintain customer records, and generate reports.',
    solution:
      'Developed a web-based booking system using PHP and MySQL with role-based access control. Implemented booking workflows, service management, customer information tracking, and administrative reporting.',
    features: [
  ...
  },
  {
    ...
    summary:
      'Academic team project for student information management. A web-based system for tracking student records, academic performance, and attendance with real-time updates.',
    problem:
    ...
    myRole:
      'Lead System Developer responsible for system architecture, database design, backend implementation, and team coordination. Focused on testing, debugging, and performance optimization.',
